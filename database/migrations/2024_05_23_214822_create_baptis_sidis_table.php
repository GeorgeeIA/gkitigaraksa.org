...
return new class extends Migration
{
    ...
    {
        Schema::create('baptis_sidis', function (Blueprint $table) {
            $table->id();
            ...
            $table->text('alamat');
            $table->string('tempat_baptis_anak');
            $table->date('tanggal_baptis_anak');
            $table->string('nomor_hp');
            $table->text('surat_baptis_anak');
            $table->text('pas_foto');
    ...
    {
        Schema::dropIfExists('baptis_sidis');
    }
};
