                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.atestasi_masuk.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="Tempat Tanggal Lahir" value="{{$data->tempat_lahir}} {{date('d-m-Y', strtotime($data->tanggal_lahir))}}"
                                        @readonly(true) class="form-control">
                                </div>

                                <div class="form-group">
                                    <label for="Nomor Hp">Nomor Hp</label>
                                    <input type="text" name="Nomor Hp" value="{{$data->nomor_hp}}"
                                        @readonly(true) class="form-control">
                                </div>
