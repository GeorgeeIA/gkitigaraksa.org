                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.baptisAnak.update', $data->id) }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label for="Nama">Nama Anak</label>
                                    <input type="text" name="nama" value="{{ $data->nama_anak }}" @readonly(true)
                                        class="form-control">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_pendeta" value="{{ old('nama_pendeta') }}" placeholder="Masukan Nama Pendeta"
                                        class="form-control">
