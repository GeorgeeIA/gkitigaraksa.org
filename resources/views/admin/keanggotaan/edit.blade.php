                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.keanggotaan.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    <label for="gereja">Nama Gereja</label>
                                    <input type="text"  value="{{$data->nama_gereja}} "
                                        @readonly(true) class="form-control">
                                </div>


                                <div class="form-group">
                                    <label for="gereja">Daerah Gereja</label>
                                    <input type="text"  value="{{$data->alamat_gereja}} "
                                        @readonly(true) class="form-control">
                                </div>
