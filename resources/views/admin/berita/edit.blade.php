                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="isi" id="summernote"  class="note-codable">{{ $data->isi }}</textarea>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="is_publish" id="is_publish" class="form-control" required>
                                      ...
                                      <option value="1" {{$data->is_publish == '1' ? 'selected' : ''}}>Pubish</option>
                                      <option value="0" {{$data->is_publish == '0' ? 'selected' : ''}}>Draft</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="tanggal_publish" value="{{ $data->tanggal_publish }}"
                                        required class="form-control">
