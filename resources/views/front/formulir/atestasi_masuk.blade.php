    ...
    <div id="FormDaftar" class="container my-5">
        <div class="card custom-card">
            <div class="p-5">
                ...
                <div class="card p-3">
                    <form action="{{route('formulir.atestasi_masuk.store')}}" method="post" enctype="multipart/form-data">
                        @csrf

                        <h5 class="card-title">Formulir Atestasi Masuk</h5>
                        <hr />
                        ...
                        <div class="form-group d-flex justify-content-between">
                            <label for="surat_baptis">Scan Surat Baptis/Sidi</label>
                            <input type="file" class="form-control-file" name="surat_baptis" id="surat_baptis" required
                             accept="application/pdf/png/jpg" />
                        </div>

                        <div class="form-group d-flex justify-content-between">
                            <label for="surat_atestasi">Scan Surat Atestasi/Surat keterangan dari Gereja
                                Asal</label>
                            <input type="file" class="form-control-file" name="surat_atestasi" id="surat_atestasi" required
                             accept="application/pdf/png/jpg" />
                        </div>
