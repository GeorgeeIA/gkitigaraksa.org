        ...
        <div class="card custom-card">
            <div class="p-5">
                ...
                @if (session('success'))
                    ...
                    <div class="card p-3">
                        <form action="{{ route('formulir.sidi.store') }}" method="post" enctype="multipart/form-data">
                            @csrf

                            <h5 class="card-title">Formulir Baptis Sidi</h5>
                            <hr />
                            ...
                            <div class="form-group d-flex justify-content-between">
                                <label for="tempat_baptis_anak">Masukkan Baptis Anak (Tempat)
                                </label>
                                <input type="text" class="form-control" name="tempat_baptis_anak"
                                    id="tempat_baptis_anak" required placeholder="Enter  Tempat Lahir " />
                                @error('tempat_baptis_anak')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>

                            <div class="form-group d-flex justify-content-between">
                                <label for="tanggal_baptis_anak">Masukkan Baptis Anak (Tanggal)
                                </label>
                                <input type="date" class="form-control" name="tanggal_baptis_anak"
                                    id="Masukantanggal_baptis_anak" required placeholder="Enter  Tempat Lahir " />
                                @error('tanggal_baptis_anak')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>

                            <div class="form-group d-flex justify-content-between">
                                <label for="surat_baptis_anak">Scan Surat Baptisan Anak</label>
                                <input type="file" class="form-control-file" name="surat_baptis_anak"
                                    id="surat_baptis_anak" required accept="application/pdf/png/jpg" />
                                @error('surat_baptis_anak')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="form-group d-flex justify-content-between">
                                ...
                                <input type="file" class="form-control-file" name="pas_foto" id="pas_foto"
