    ...
    <div id="FormDaftar" class="container my-5">
        <div class="card custom-card">
            <div class="p-5">
                ...
                <div class="card p-3">
                    <form action="{{ route('formulir.atestasi.store') }}" method="post">
                        @csrf
                        <h5 class="card-title">Formulir Atestasi Keluar/Pindah</h5>
                        <hr />
                        ...
                        <p>Diatestasikan/Dipindahkan Ke :</p>

                        <div class="form-group d-flex justify-content-between">
                            <label for="gereja">Masukkan Nama Gereja/Jemaat</label>
                            <input type="text" class="form-control" name="gereja" id="gereja" required
                                placeholder="Enter Nama" />
                        </div>

                        <div class="form-group d-flex justify-content-between">
                            <label for="alamat_gereja" id="form-pilih">Masukkan Alamat</label>
                            <textarea class="form-control" id="alamat_gereja" name="alamat_gereja" rows="3" required></textarea>
                        </div>

                        <div class="form-group d-flex justify-content-between">
                            <label for="alasan">Alasan Atestasi/Pindah</label>
                            <input type="text" class="form-control" name="alasan" id="alasan" required
                                placeholder="Enter Nama" />
                        </div>

                        <div class="form-group">
                            <label for="anggota_keluarga" id="form-pilih">Masukkan Anggota Keluarga</label>
                            <div id="anggotaKeluargaContainer" style="flex: 2;">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="anggota_keluarga[]"
                                        placeholder="Nama Anggota Keluarga" />
                                    <div class="input-group-append">
                                        <button class="btn btn-success add-button" type="button">Tambah</button>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.add-button', function() {
                ...
                var jumlahInput = $('#anggotaKeluargaContainer').find('.input-group').length;


                if (jumlahInput < maxAnggota) {
                    var newInput = `
                      <div class="input-group mb-3">
                          <input type="text" class="form-control" name="anggota_keluarga[]" placeholder="Nama Anggota Keluarga" />
                          <div class="input-group-append">
                              <button class="btn btn-danger remove-button" type="button">Hapus</button>
                          </div>
                      </div>`;
                    $('#anggotaKeluargaContainer').append(newInput);
                } else {
                    alert('Maaf, Anda hanya dapat menambahkan maksimal 4 anggota keluarga.');
                }
            });
