        ...
        <div class="card custom-card">
            <div class="p-5">
                ...
                @if (session('success'))
                    ...
                    <div class="card p-3">
                        <form action="{{ route('formulir.izin_nikah.store') }}" method="post" enctype="multipart/form-data">
                            @csrf

                            <h5 class="card-title">Formulir Izin Nikah</h5>
                            <hr />
                            ...
                            <div class="form-group d-flex justify-content-between">
                                ...
                                <input type="text" class="form-control" name="nama_gereja" id="nama_gereja"
                                    required placeholder="Enter  Nama Gereja " />
                                @error('nama_gereja')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="form-group d-flex justify-content-between">
                                <label for="daerah_gereja">Masukkan Daerah Gereja (Yang Dituju)
                               </label>
                                <input type="text" class="form-control" name="daerah_gereja" id="daerah_gereja"
                                    required placeholder="Enter  Daerah Gereja " />
                                @error('daerah_gereja')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
