    ...
    <div id="FormDaftar" class="container my-5">
        <div class="card custom-card">
            <div class="p-5">
                ...
                <div class="card p-3">
                    <form action="{{route('formulir.keanggotaan.store')}}" method="post" enctype="multipart/form-data">
                        @csrf

                        <h5 class="card-title">Formulir Keanggotan Jemaat</h5>
                        <hr />
                        ...
                        <div class="form-group d-flex justify-content-between">
                            ...
                            <input type="text" class="form-control" name="tempat_lahir" id="Masukantempat_lahir" required
                            placeholder="Enter  Tempat Lahir " />
                        </div>


                        <div class="form-group d-flex justify-content-between">
                            <label for="tanggal_lahir">Masukkan Tempat Lahir</label>
                        ...
                        <div class="form-group d-flex justify-content-between">
                            <label for="nama_gereja">Masukkan Nama Gereja (Yang Dituju)</label>
                            <input type="text" class="form-control" name="nama_gereja" id="nama_gereja" required
                            placeholder="Enter Nama Gereja " />
                        </div>

                        <div class="form-group d-flex justify-content-between">
                            <label for="alamat_gereja">Masukkan Daerah Gereja (Yang Dituju)</label>
                            <input type="text" class="form-control" name="alamat_gereja" id="alamat_gereja" required
                            placeholder="Enter Daerah Gereja " />
                        </div>
