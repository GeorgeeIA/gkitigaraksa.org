    ...
    <div id="FormDaftar" class="container my-5">
        <div class="card custom-card">
            <div class="p-5">
                ...
                <div class="card p-3">
                    <form action="{{ route('formulir.baptisAnak.store') }}" method="post"
                        enctype="multipart/form-data">
                        @csrf

                        <h5 class="card-title">Formulir Baptis Anak</h5>
                        <hr />

                        <div class="form-group d-flex justify-content-between">
                            <label for="nama_ayah">Masukkan Nama Ayah</label>
                        ...
                        <div class="form-group d-flex justify-content-between">
                            <label for="nama_anak">Masukkan Nama Anak</label>
                        ...
                        <div class="form-group d-flex justify-content-between">
                            ...
                            <input type="file" class="form-control-file" name="akte_kelahiran"
                                id="akte_kelahiran" required accept="application/pdf/png/jpg" />
                    ...
                    {{-- <form action="hasil.php" method="post" enctype="multipart/form-data">
                        ...
                        <hr />
                        <div class="form-group d-flex justify-content-between">
                            <label for="exampleInputNama">Masukkan Nama Ayah</label>
                            <input type="text" class="form-control" name="MasukanNamaAyah" id="MasukanNamaAyah"
                                required placeholder="Enter Nama Ayah" />
                        </div>
                        <div class="form-group d-flex justify-content-between">
                            <label for="exampleInputNama">Masukkan Nama Ibu</label>
                            <input type="text" class="form-control" name="MasukanNamaIbu" id="MasukanNamaIbu"
                                required placeholder="Enter Nama Ibu" />
                        </div>

                        <div class="form-group d-flex justify-content-between">
                            <label for="exampleFormControlTextarea1" id="form-pilih">Masukkan Alamat</label>
                        ...
                        <div class="form-group d-flex justify-content-between">
                            ...
                            <input type="number" class="form-control" name="NomorHP"
                                onchange="console.log(this.value)" required placeholder="Enter NomorHP" />
                        </div>

                        <div class="form-group d-flex justify-content-between">
                            <label for="exampleInputNama">Masukkan Nama Anak </label>
                            <input type="text" class="form-control" name="MasukanNamaAnak" id="MasukanNamaAnak"
                                required placeholder="Enter Nama Anak " />
                        </div>

                        <div class="form-group d-flex justify-content-between">
                            <label for="exampleFormControlFile1">Scan Akte Kelahiran</label>
                            <input name="data[]" type="file" class="form-control-file" id="berkas" required
                                accept="application/pdf/png/jpg" disabled="false" />
                        </div>

                        <div class="form-group d-flex justify-content-between">
                            <label for="exampleFormControlFile1">Pas Foto 3 x 4</label>
                            <input name="data[]" type="file" class="form-control-file" id="berkas" required
                                accept="application/pdf/png/jpg" disabled="false" />
                        </div>
