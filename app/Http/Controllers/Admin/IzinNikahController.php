...
class IzinNikahController extends Controller
{
  ...
  {
    $data = IzinNikah::orderBy('created_at', 'DESC')->get();

    return view('admin.izin_nikah.index', compact('data'));
  }

  public function edit($id)
  {
    $data = IzinNikah::find($id);
    ...
    return view('admin.izin_nikah.edit', compact('data', 'ketuas', 'sekretaris', 'gembala'));
  }
  ...
  public function update(Request $req, $id)
  {
    ...
    try {
      ...
      return redirect(route('admin.izin_nikah.index'))->with('success', 'Berhasil konfirmasi formulir');
    } catch (\Throwable $th) {
