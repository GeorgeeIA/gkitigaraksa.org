...
class SidiController extends Controller
{
  ...
  {
    $data = BaptisSidi::orderBy('created_at', 'DESC')->get();

    return view('admin.baptis_sidi.index', compact('data'));
  }

  public function edit($id)
  {
    $data = BaptisSidi::find($id);
    ...
    return view('admin.baptis_sidi.edit', compact('data', 'ketuas', 'gembala'));
  }
  ...
  public function update(Request $req, $id)
  {
    ...
    try {
      ...
      return redirect(route('admin.sidi.index'))->with('success', 'Berhasil konfirmasi formulir');
    } catch (\Throwable $th) {
